FROM khulnasoft/workspace-full:2023-08-08-12-42-30
...
RUN curl -sSL https://github.com/khulnasoft/dazzle/releases/download/v${DAZZLE_VERSION}/dazzle_${DAZZLE_VERSION}_Linux_x86_64.tar.gz | tar -xvz -C /usr/local/bin

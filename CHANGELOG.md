...
A curated, chronologically ordered list of notable changes in [Khulnasoft's default workspace images](https://hub.docker.com/u/khulnasoft).
...
- Temporarily pin the version of Docker. Refer to [19662](https://github.com/khulnasoft/khulnasoft/issues/19662#issuecomment-2083388559) for more detail.
...
- Fix MySQL image by updating mysql.cnf for MySQL `8`, fixes [khulnasoft/khulnasoft#1399](https://github.com/khulnasoft/khulnasoft/issues/1399)

## 2020-04-15

- Upgrade from Ubuntu `19.04` → Ubuntu `20.04 LTS`, because `19.04` reached end-of-life and all its apt packages got deleted [khulnasoft/khulnasoft#1398](https://github.com/khulnasoft/khulnasoft/issues/1398)
